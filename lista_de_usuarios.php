...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
            ...
            <td>
            <a href='editar.php?id=".$row['id_usuario']."' class='btn-excluir' style='background-color: #f39c12; border-radius: 5px;'>Editar</a>
            <a href='excluir.php?id=".$row['id_usuario']."' class='btn-excluir'>Excluir</a>
            </td>
        </tr>";
    }
}
